...
> コンパイル・リンク時間短縮、および、クラス修正時の影響範囲（再コンパイル）を最小限にするために、ソースファイルを「宣言部」（.h）、「インライン関数／テンプレート関数定義部」（.inl）、「関数定義部」（.cpp.h）の三つに分けています。  
...
* `gasha/comb_sort.h` ［テンプレート関数］**コムソート**  
...
**【挿入ソート】**  
* `gasha/insertion_sort.h` ［テンプレート関数］**挿入ソート** *1 *3  
* `gasha/shell_sort.h` ［テンプレート関数］**シェルソート** *3  

**【マージソート】**  
* `gasha/inplace_merge_sort.h` ［テンプレート関数］**インプレースマージソート** *1  

**【混成ソート】**  
* `gasha/intro_sort.h` ［テンプレート関数］**イントロソート** *3  

**【分布ソート】**※非比較ソート  
* `gasha/radix_sort.h` ［テンプレート関数］**基数ソート** *1 *2  

**【整列状態確認】**  
* `gasha/is_ordered.h` ［テンプレート関数］**整列状態確認** *3  
...
* 【検討中】`gasha/graph.h` ［テンプレートクラス］**グラフ**  
...
* 【検討中】`gasha/hierarchy.h` ［テンプレートクラス］**階層**  
> * 階層構造データ。  
...
* 【検討中】`gasha/spatial_partitioning.h` ［テンプレートクラス］**空間分割**  

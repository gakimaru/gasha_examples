...
void example_singly_linked_list()
{
	...
	{
		std::printf("--------------------------------------------------------------------------------\n");
		std::printf("[Test for singly_linked_list::container(User defined type)]\n");
	...
	#ifdef TEST_ITERATOR_OPERATION
		{
			...
			if (ite_bb.isExist()) std::printf("ite_bb: key=%d, value=%d\n", ite_bb->m_key, ite_bb->m_val);
			...
			if (rite2_bb.isExist()) std::printf("rite2_bb: key=%d, value=%d\n", rite2_bb->m_key, rite2_bb->m_val);
			...
			std::printf("ite - ite_bb = %d\n", ite - ite_bb);
			std::printf("ite_bb - ite = %d\n", ite_bb - ite);
			...
			std::printf("rite2 - rite2_bb = %d\n", rite2 - rite2_bb);
			std::printf("rite2_bb - rite2 = %d\n", rite2_bb - rite2);
		...
		std::printf("\n");
		std::printf("[before_begin + insert_after]\n");
		{
	...
	{
		std::printf("--------------------------------------------------------------------------------\n");
		std::printf("[Test for singly_linked_list::container(User defined type with custom operator type)]\n");
	...
	//テスト③：大量登録テスト
	{
		...
		{
			std::printf("--------------------------------------------------------------------------------\n");
			std::printf("[Test for performance singly_linked_list]\n");
		...
		{
			std::printf("--------------------------------------------------------------------------------\n");
			std::printf("[Test for performance std::forward_list]\n");
			...
			//リバースイテレータ（非対応）
			std::printf("\n");
			std::printf("[reverse_iterator] ... is not available.\n");
		#endif//GASHA_SINGLY_LINKED_LIST_ENABLE_REVERSE_ITERATOR
		#endif//ENABLE_REVERSE_ITERATOR_TEST

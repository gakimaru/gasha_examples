...
void example_basic_math()
{
	...
	printf("\n");
	printf("----- Calculate pow for Runtime -----\n");
	{
		...
		printf("pow<int, e>(2) = {%d, %d, %d, %d, %d} (e=0, 1, 2, 3, 4)\n", ni0, ni1, ni2, ni3, ni4);
		printf("pow<float, e>(2.f) = {%.1f, %.1f, %.1f, %.1f, %.1f} (e=0, 1, 2, 3, 4)\n", nf0, nf1, nf2, nf3, nf4);
		printf("negaPow<float, -e>(2.f) = {%.4f, %.4f, %.4f, %.4f, %.4f} (e=0, -1, -2, -3, -4)\n", nfm0, nfm1, nfm2, nfm3, nfm4);
	}

	//--------------------
	//【メタプログラミング版】べき乗テスト
	printf("\n");
	printf("----- Calculate pow for Meta-programming -----\n");
	{
		...
		printf("staticPow<2, e> = {%d, %d, %d, %d, %d} (e=0, 1, 2, 3, 4)\n", n0, n1, n2, n3, n4);
	}
	...
	printf("\n");
	printf("----- Calculate bits for Runtime -----\n");
	...
	printf("\n");
	printf("----- Calculate bits for Meta-programming -----\n");

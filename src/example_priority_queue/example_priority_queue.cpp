...
void example_priority_queue()
{
...
#ifdef TEST_ITERATOR_OPERATION
	{
		...
		if (ite.isExist()) std::printf("ite:[%d] priority=%d, seqNo=%d, value=%d\n", static_cast<int>(ite.getIndex()), ite->m_priority, ite->m_seqNo, ite->m_val);
		if (rite.isExist()) std::printf("rite:[%d] priority=%d, seqNo=%d, value=%d\n", static_cast<int>(rite.getIndex()), rite->m_priority, rite->m_seqNo, rite->m_val);
		if (ite_end.isExist()) std::printf("ite_end:[%d] priority=%d, seqNo=%d, value=%d\n", static_cast<int>(ite_end.getIndex()), ite_end->m_priority, ite_end->m_seqNo, ite_end->m_val);
		if (rite_end.isExist()) std::printf("rite_end:[%d] priority=%d, seqNo=%d, value=%d\n", static_cast<int>(rite_end.getIndex()), rite_end->m_priority, rite_end->m_seqNo, rite_end->m_val);
		if (ite2.isExist()) std::printf("ite2:[%d] priority=%d, seqNo=%d, value=%d\n", static_cast<int>(ite2.getIndex()), ite2->m_priority, ite2->m_seqNo, ite2->m_val);
		if (rite2.isExist()) std::printf("rite2:[%d] priority=%d, seqNo=%d, value=%d\n", static_cast<int>(rite2.getIndex()), rite2->m_priority, rite2->m_seqNo, rite2->m_val);
		if (ite2_end.isExist()) std::printf("ite2_end:[%d] priority=%d, seqNo=%d, value=%d\n", static_cast<int>(ite2_end.getIndex()), ite2_end->m_priority, ite2_end->m_seqNo, ite2_end->m_val);
		if (rite2_end.isExist()) std::printf("rite2_end:[%d] priority=%d, seqNo=%d, value=%d\n", static_cast<int>(rite2_end.getIndex()), rite2_end->m_priority, rite2_end->m_seqNo, rite2_end->m_val);
